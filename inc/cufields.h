...
namespace cufields
{
    ...
    extern __global__ void CSpMV_CSR_OffDiag(unsigned int,unsigned int*,unsigned int*,float*,float*,float*,float*,float*,float*,float*,float*,float*,double*,float*,float*);
