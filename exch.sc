...
exchange_0_0:
{
    ...
    //Units of energy
    units = "joules";
    Shell1Vec = [ 0.0 , 1.0 , 0.0 ];
    NumInt1 = 6;
    //Exchange Tensor First number is shell and second is row of tensor
    J1_1 = [ 1.0000e-20 , 0.000 , 0.000 ];
    J1_2 = [ 0.000 , 1.0000e-20 , 0.000 ];
    J1_3 = [ 0.000 , 0.000 , 1.0000e-20 ];
};
exchange_0_1:
{
    Num_Shells = 1;
    ...
    NumInt1 = 6;
    //Exchange Tensor First number is shell and second is row of tensor
    J1_1 = [ 0.000e-21 , 0.000 , 0.000 ];
    J1_2 = [ 0.000 , 0.000e-21 , 0.000 ];
    J1_3 = [ 0.000 , 0.000 , 0.000e-21 ];
};
exchange_1_1:
{
    Num_Shells = 1;
