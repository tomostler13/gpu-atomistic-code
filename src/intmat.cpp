...
// Author:Tom Ostler
// Created: 16 Jan 2012
// Last-modified: 08 Oct 2014 13:07:07
#include <fftw3.h>
#include <cmath>
#include <iostream>
#include <cstdlib>
...
namespace intmat
{
    ...
    void initIntmat(int argc,char *argv[])
    {
        ...
        ftP=fftw_plan_many_dft(3,n,howmany,Nrab.ptr(),inembed,istride,idist,Nkab.ptr(),onembed,ostride,odist,FFTW_FORWARD,FFTW_MEASURE);
