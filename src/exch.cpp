...
// Author: Tom Ostler
// Created: 18 Jan 2013
// Last-modified: 22 Apr 2013 11:53:50
                            ...
                            for(unsigned int b = 0 ; b < 2 ; b++)
                            {
                                for(unsigned int c = 0 ; c < 2 ; c++)
                                {
                                    ...
                                    if(check(wc[0],wc[1],wc[2])==0)
                                    {
                                        ...
                                        {
                                            intmat::Nrxx(wc[0],wc[1],wc[2])+=(J(i,0,0)/(mat::muB*mat::mu[0]));
                                            intmat::Nrxy(wc[0],wc[1],wc[2])+=(J(i,0,1)/(mat::muB*mat::mu[0]));
                                            intmat::Nrxz(wc[0],wc[1],wc[2])+=(J(i,0,2)/(mat::muB*mat::mu[0]));
                                            intmat::Nryx(wc[0],wc[1],wc[2])+=(J(i,1,0)/(mat::muB*mat::mu[0]));
                                            intmat::Nryy(wc[0],wc[1],wc[2])+=(J(i,1,1)/(mat::muB*mat::mu[0]));
                                            intmat::Nryz(wc[0],wc[1],wc[2])+=(J(i,1,2)/(mat::muB*mat::mu[0]));
                                            intmat::Nrzx(wc[0],wc[1],wc[2])+=(J(i,2,0)/(mat::muB*mat::mu[0]));
                                            intmat::Nrzy(wc[0],wc[1],wc[2])+=(J(i,2,1)/(mat::muB*mat::mu[0]));
                                            intmat::Nrzz(wc[0],wc[1],wc[2])+=(J(i,2,2)/(mat::muB*mat::mu[0]));
            ...
            else if(method=="direct")
            {
                ...
                for(unsigned int i = 0 ; i < noint ; i++)
                {
                    ...
                    if(check(c[0],c[1],c[2])==0)//then we do not already have an interaction there
                    {
                        ...
                        {
                            intmat::Nrxx(c[0],c[1],c[2])+=(J[0][0]/(mat::muB*mat::mu[0]));
                            intmat::Nrxy(c[0],c[1],c[2])+=(J[0][1]/(mat::muB*mat::mu[0]));
                            intmat::Nrxz(c[0],c[1],c[2])+=(J[0][2]/(mat::muB*mat::mu[0]));
                            intmat::Nryx(c[0],c[1],c[2])+=(J[1][0]/(mat::muB*mat::mu[0]));
                            intmat::Nryy(c[0],c[1],c[2])+=(J[1][1]/(mat::muB*mat::mu[0]));
                            intmat::Nryz(c[0],c[1],c[2])+=(J[1][2]/(mat::muB*mat::mu[0]));
                            intmat::Nrzx(c[0],c[1],c[2])+=(J[2][0]/(mat::muB*mat::mu[0]));
                            intmat::Nrzy(c[0],c[1],c[2])+=(J[2][1]/(mat::muB*mat::mu[0]));
                            intmat::Nrzz(c[0],c[1],c[2])+=(J[2][2]/(mat::muB*mat::mu[0]));
