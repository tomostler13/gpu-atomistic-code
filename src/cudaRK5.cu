...
namespace cullg
{
    ...
    void llgGPURK5(unsigned int& t)
    {
        ...
        if(config::exchm==0)
        {
            ...
            error::errMessage("GPU code for RK5 integration with FFT calculated exchange fields not yet implemented");
        }
        else if(config::exchm>0 && config::dipm==0 && config::inc_dip==true)
        {
            ...
            if(config::exchm==1)//DIA
            {
                if(!config::offdiag)
                {
                    ...
                    cuintRK5::CdetRK5k1<<<blockspergrid,threadsperblock>>>(geom::nspins,llg::T,llg::applied[0],llg::applied[1],llg::applied[2],CH,Cspin,Cespin,CRKk1,Crand,Csigma,Cllgpf,Clambda,Ck1u,Ck1udir,CHstg);
                    ...
                    cuintRK5::CdetRK5k2<<<blockspergrid,threadsperblock>>>(geom::nspins,llg::T,llg::applied[0],llg::applied[1],llg::applied[2],CH,Cspin,Cespin,CRKk2,CRKk1,Crand,Csigma,Cllgpf,Clambda,Ck1u,Ck1udir,CHstg);
                    cufields::CSpMV_DIA<<<blockspergrid,threadsperblock>>>(geom::nspins,Cdiagoffset,Cdxx,Cdyy,Cdzz,Cespin,CHDemag,CH);
                    cuintRK5::CdetRK5k3<<<blockspergrid,threadsperblock>>>(geom::nspins,llg::T,llg::applied[0],llg::applied[1],llg::applied[2],CH,Cspin,Cespin,CRKk3,CRKk2,CRKk1,Crand,Csigma,Cllgpf,Clambda,Ck1u,Ck1udir,CHstg);
                    cufields::CSpMV_DIA<<<blockspergrid,threadsperblock>>>(geom::nspins,Cdiagoffset,Cdxx,Cdyy,Cdzz,Cespin,CHDemag,CH);
                    cuintRK5::CdetRK5k4<<<blockspergrid,threadsperblock>>>(geom::nspins,llg::T,llg::applied[0],llg::applied[1],llg::applied[2],CH,Cspin,Cespin,CRKk4,CRKk3,CRKk2,CRKk1,Crand,Csigma,Cllgpf,Clambda,Ck1u,Ck1udir,CHstg);
                    cufields::CSpMV_DIA<<<blockspergrid,threadsperblock>>>(geom::nspins,Cdiagoffset,Cdxx,Cdyy,Cdzz,Cespin,CHDemag,CH);
                    cuintRK5::CdetRK5k5<<<blockspergrid,threadsperblock>>>(geom::nspins,llg::T,llg::applied[0],llg::applied[1],llg::applied[2],CH,Cspin,Cespin,CRKk5,CRKk4,CRKk3,CRKk2,CRKk1,Crand,Csigma,Cllgpf,Clambda,Ck1u,Ck1udir,CHstg);
                    cufields::CSpMV_DIA<<<blockspergrid,threadsperblock>>>(geom::nspins,Cdiagoffset,Cdxx,Cdyy,Cdzz,Cespin,CHDemag,CH);
                    cuintRK5::CdetRK5k6<<<blockspergrid,threadsperblock>>>(geom::nspins,llg::T,llg::applied[0],llg::applied[1],llg::applied[2],CH,Cspin,Cespin,CRKk6,CRKk5,CRKk4,CRKk3,CRKk2,CRKk1,Crand,Csigma,Cllgpf,Clambda,Ck1u,Ck1udir,CHstg);
        ...
        cuintRK5::CdetSnp1<<<blockspergrid,threadsperblock>>>(geom::nspins,Cspin,CRKk1,CRKk2,CRKk3,CRKk4,CRKk5,CRKk6);
