// File: cuda.cu
// Author:Tom Ostler
// Last-modified: 18 Mar 2014 12:52:12
// Formally cuLLB.cu
#include "../inc/cuda.h"
...
/*		if((cudaSetDevice(device))!=cudaSuccess)
	...
	void allocate_memory_on_card()
	{
        ...
        CUDA_CALL(cudaMemcpy(Clambda,mat::lambda.ptr(),geom::nspins*sizeof(double),cudaMemcpyHostToDevice));
        if(config::useintmat)
        {
            int *sn=NULL;
            sn=new int[geom::zps];
